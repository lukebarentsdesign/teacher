...
function SidebarContent({
  ...
  return (
    <div className="flex h-full flex-col gap-6 overflow-y-auto px-3 py-5">
      ...
      {/* Assistance Banner / Upgrade Banner */}
      <div className="mt-auto px-1 pt-4 border-t border-white/10">
        {!isPaidTier ? (
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-amber-400 to-amber-500 p-4 shadow-lg text-neutral-900 animate-pulse-subtle">
            <div className="flex flex-col gap-1.5">
              <span className="text-xs font-black">TeachBase Pro</span>
              <span className="text-[10px] font-bold leading-normal text-neutral-800">Unlock all 8 advanced modules for £25/mo.</span>
              <Link href="/dashboard/upgrade" onClick={onNavigate} className="mt-2 text-center text-[10px] font-black text-white bg-neutral-950 hover:bg-neutral-850 px-3 py-2 rounded-lg transition-colors">
                Upgrade Now
              </Link>
            </div>
          </div>
