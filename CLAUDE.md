...
8. [x] Room booking, GroupClass, Assessment, LoanableItem/Loan modules — full CRUD, mostly nested under School/Student detail pages; Loans has its own top-level nav entry.
